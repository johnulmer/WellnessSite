...
public class TeamMemberJSONController {
	 ...
	 *
	 * @param member A Member object (must have int ID set at minimum) who will be added to a Team.
	 * @param team   A Team object (must have int ID set at a minimum) to which a Member will be added.
	 * @see          Member
	 * @see          Team
	 */
...
//	@RequestMapping(path = "/api/joinedTeams/{memberID}", method = RequestMethod.GET)
